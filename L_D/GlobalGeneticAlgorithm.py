...
class GlobalGeneticAlgorithmOptimization:
    ...
    def solve(self, alphas, t):
        ...
        for i in range(1, len(t) - 1):
            ...
            args = (g, m, alphas[i], gamma, x_lst, y_lst)
            ...
            #N = Get_Normal(V, h, gamma, x_lst, y_lst, alphas[i])
            #T = Get_Tangential(V, h, gamma, x_lst, y_lst, alphas[i])
        
            L[i], D[i] = Get_LD(V[i], h[i], gamma, x_lst, y_lst, alphas[i])
